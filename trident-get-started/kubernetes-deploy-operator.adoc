...
* Manually: Trident provides a link:https://github.com/NetApp/trident/blob/stable/v22.04/deploy/bundle.yaml[bundle.yaml^] file that can be used to install the operator and create associated objects.
...
* You have full privileges to a supported Kubernetes cluster running Kubernetes 1.18 - 1.24.
